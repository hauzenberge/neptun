			...
			<div class="container">
                ...
                <div class="slider-wrap">
                    ...
                    @foreach($contents['other'] as $item)
                        ...
                        @if($item->image)
                            <img src="{{url('storage/'.$item->image)}}" alt="{{$page['title']}}">
                        @endif
                            
                            <div class="text-slider">{!!$item->content!!}</div>
                        </div>
                    @endforeach
                    </div>
                    
                    <button class="left-arr slick-arrow"></button>
                    <button class="right-arr slick-arrow"></button>
                </div>
			</div>
